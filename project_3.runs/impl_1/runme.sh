...
HD_PWD='C:/Users/user/Documents/FPGA/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log robot.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source robot.tcl -notrace
