...
HD_PWD='C:/Users/user/Documents/FPGA/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log robot.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source robot.tcl
