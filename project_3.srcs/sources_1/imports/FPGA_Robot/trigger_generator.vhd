...
BEGIN
    ...
    PROCESS (clk)
        CONSTANT ms100 : std_logic_vector(23 DOWNTO 0) := "010011000100101101000000";--20ns/100ms-- constant ms100And20us: std_logic_vector(23 downto 0) := "010011000100111100100110";
    ...
    BEGIN
      ...
      IF (outputCounter = ms100and20us OR
         ...
         -- IF (outputCounter >= ms100and20us) THEN
            resetCounter <= '0';
        ELSE
            resetCounter <= '1';
        END IF;
